...
import com.amazon.ecommerce.client.notification.NotificationClient;
...
//                "http://FRAUD-CHECK-APPLICATION/api/v1/fraud-check?customer_id=1&email=email@email.com",
//                SuccessResponse.class
//        );
        SuccessResponse successResponse = fraudCheckClient.checkIfFraudulent(id,email);
        SuccessResponse successResponse1 = notificationClient.checkForNotification(email);
